...
class PrivateIngredientsApiTest(TestCase):
    ...
    def test_ingredients_list_limited_to_user(self):
        """Test lisf of ingredients is limited to authenticated user."""
    ...
    def test_filter_ingredients_assigned_to_recipes(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name='Turki')
    ...
    def test_filtered_ingredients_unique(self):
        ...
        in1 = Ingredient.objects.create(user=self.user, name='Col')
